    ...
    <section className="container py-5">
      <div className="row g-4 mb-4">
        <div className="col-12 col-lg-4">
          <div className="card shadow-sm border-0 h-100 dtext">
            <img
              src={ownerImage}
            ...
            <div className="card-body">
              ...
              <p className="mb-2">{t(about.owner.role)}</p>
      ...
      <div className="card shadow-sm border-0 mb-4 dtext">
        <div className="card-body p-4 p-md-5 ">
          <h1 className="fw-bold mb-2">{t(about.title)}</h1>
          <p className="fs-5 mb-3">{t(about.subtitle)}</p>
      ...
      <div className="row g-3">
        {about.highlights.map((item) => (
          <div className="col-6 col-lg-3" key={item.label.en}>
            <div className="card h-100 border-0 shadow-sm text-center dtext">
              <div className="card-body about">
                <p className="mb-1 small">{t(item.label)}</p>
